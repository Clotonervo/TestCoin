...
%{_sbindir}/semanage port -a -t raven_port_t -p tcp 8746
%{_sbindir}/semanage port -a -t raven_port_t -p tcp 8747
%{_sbindir}/semanage port -a -t raven_port_t -p tcp 18746
%{_sbindir}/semanage port -a -t raven_port_t -p tcp 18747
...
if [ $1 -eq 0 ]; then
	if [ `%{_sbindir}/sestatus |grep -c "disabled"` -eq 0 ]; then
	%{_sbindir}/semanage port -d -p tcp 8746
	%{_sbindir}/semanage port -d -p tcp 8747
	%{_sbindir}/semanage port -d -p tcp 18746
	%{_sbindir}/semanage port -d -p tcp 18747
