...
{
    const char* pszTimestamp = "Washington Post 7/10/2021 Returning to school was supposed to be great. The reality was more complicated";
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1625936969, 25023712, 0x1e00ffff, 4, 50000 * COIN);
...
public:
    CTestNetParams() {
        ...
        uint32_t nGenesisTime = 1625936969;  // Saturday, July 10 2021
...
//        /////////////////////////////////////////////////////////////////
    ...
    //        genesis = CreateGenesisBlock(nGenesisTime, i, 0x1e00ffff, 2, 50000 * COIN);
...
//        /////////////////////////////////////////////////////////////////
        ...
        genesis = CreateGenesisBlock(nGenesisTime, 15615880, 0x1e00ffff, 2, 50000 * COIN);
        consensus.hashGenesisBlock = genesis.GetX16RHash();
...
//        uint256 BestBlockHash = uint256S("0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff");
//        for (int i=0;i<40000000;i++) {
//            genesis = CreateGenesisBlock(1533751200, i, 0x207fffff, 2, 50000 * COIN);
//            //genesis.hashPrevBlock = TempHashHolding;
//            consensus.hashGenesisBlock = genesis.GetHash();
//
//            arith_uint256 BestBlockHashArith = UintToArith256(BestBlockHash);
...
//        /////////////////////////////////////////////////////////////////
        ...
        genesis = CreateGenesisBlock(1524179366, 1, 0x207fffff, 4, 50000 * COIN);
        consensus.hashGenesisBlock = genesis.GetX16RHash();
